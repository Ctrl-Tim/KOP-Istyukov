namespace TestComponents
{
    partial class FormTest
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.listBoxModified = new ComponentsLibrary.MyVisualComponents.ListBoxModified();
            this.textBoxModified = new ComponentsLibrary.MyVisualComponents.TextBoxModified();
            ...
            this.dataGridViewModified = new ComponentsLibrary.MyVisualComponents.DataGridViewModified();
            this.wordTablesContext = new ComponentsLibrary.MyUnvisualComponents.WordTablesContext(this.components);
            this.wordTableCustom = new ComponentsLibrary.MyUnvisualComponents.WordTableCustom(this.components);
            ...
            this.wordGistagram = new ComponentsLibrary.MyUnvisualComponents.WordGistagram(this.components);
        ...
        private ComponentsLibrary.MyVisualComponents.ListBoxModified listBoxModified;
        private ComponentsLibrary.MyVisualComponents.TextBoxModified textBoxModified;
        ...
        private ComponentsLibrary.MyVisualComponents.DataGridViewModified dataGridViewModified;
        private ComponentsLibrary.MyUnvisualComponents.WordTablesContext wordTablesContext;
        private ComponentsLibrary.MyUnvisualComponents.WordTableCustom wordTableCustom;
        ...
        private ComponentsLibrary.MyUnvisualComponents.WordGistagram wordGistagram;
    }
}